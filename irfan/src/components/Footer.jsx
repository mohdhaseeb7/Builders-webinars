    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '8px 20px', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
            <a href={`tel:${CONFIG.webinar.phone}`} style={{ color: 'inherit', textDecoration: 'none', transition: 'var(--transition-smooth)', whiteSpace: 'nowrap' }} onMouseOver={(e) => e.target.style.color = 'var(--accent-cyan)'} onMouseOut={(e) => e.target.style.color = 'inherit'}>
              {CONFIG.webinar.phone}
            </a>
            <span className="footer-dot-divider">•</span>
            <a href={`mailto:${CONFIG.webinar.email}`} style={{ color: 'inherit', textDecoration: 'none', transition: 'var(--transition-smooth)', whiteSpace: 'nowrap' }} onMouseOver={(e) => e.target.style.color = 'var(--accent-cyan)'} onMouseOut={(e) => e.target.style.color = 'inherit'}>
